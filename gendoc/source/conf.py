# -*- coding: utf-8 -*-
#
# cottoncandy documentation build configuration file, created by
...
copyright = u'Anwar O. Nunez-Elizalde'
...
exclude_patterns = ['build', 'Thumbs.db', '.DS_Store',
                    '**appdirs*', '**backend*', '**Encryption*',
                    '**gdriveclient*', '**options*', '**s3client*'
]
...
htmlhelp_basename = 'cottoncandydoc'
